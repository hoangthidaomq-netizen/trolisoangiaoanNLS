...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Đào - Trường Tiểu học Minh Quang - ĐT: 0971452175</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Đào - Trường Tiểu học Minh Quang - ĐT: 097 1452175 </div>", unsafe_allow_html=True)
